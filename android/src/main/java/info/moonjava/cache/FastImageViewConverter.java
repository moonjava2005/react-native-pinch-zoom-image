...
public class FastImageViewConverter {
    ...
    private static final Map<String, ScaleType> FAST_IMAGE_RESIZE_MODE_MAP =
    ...
    public static FastImageSource getImageSource(Context context, ReadableMap source) {
    ...
    public static RequestOptions getOptions(ReadableMap source) {
        // Get priority.
    ...
    public static ScaleType getScaleType(String propValue) {
